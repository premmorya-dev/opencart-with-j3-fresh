...
class __TwigTemplate_189e2581c8cd579e9cacbb1c4f9137e1e94919b355ccf62299b1914f3c819876 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  ";
        ...
        ";
                ...
                // line 33
                echo "        ";
                echo twig_call_macro($macros["self"], "macro_renderCategoriesItem", [$context["item"], $context], 33, $context, $this->getSourceContext());
                echo "
      </div>
    ";
            }
    ...
    <div class=\"tab-content\">
      ";
          ...
          ";
                // line 49
                echo twig_call_macro($macros["self"], "macro_renderCategoriesItem", [$context["item"], $context], 49, $context, $this->getSourceContext());
                echo "
        </div>
      ";
                ++$context['loop']['index0'];
      ...
      ";
          ...
          <div class=\"";
            ...
            <div class=\"panel-body\">
              ";
                // line 69
                echo twig_call_macro($macros["self"], "macro_renderCategoriesItem", [$context["item"], $context], 69, $context, $this->getSourceContext());
                echo "
            </div>
          </div>
        </div>
  ...
  ";
    ...
    <div class=\"category-";
      ...
      ";
            // line 86
            $this->loadTemplate((("journal3/template/journal3/category_" . ($context["display"] ?? null)) . ".twig"), "journal3/template/journal3/module/categories.twig", 86)->display($context);
            // line 87
            echo "    </div>
  ";
        }
...
";
    ...
    // line 1
    public function macro_renderCategoriesItem($__item__ = null, $__context__ = null, ...$__varargs__)
    {
        $macros = $this->macros;
        ...
        try {
            ...
            // line 3
            echo "  ";
            $context["categories"] = twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "categories", [], "any", false, false, false, 3);
            // line 4
            echo "  ";
      ...
      <div class=\"swiper-container\" ";
        ...
        <div class=\"swiper-wrapper category-grid\">
          ";
                // line 8
                $this->loadTemplate("journal3/template/journal3/category_grid.twig", "journal3/template/journal3/module/categories.twig", 8)->display(twig_array_merge($context, ($context["context"] ?? null)));
                // line 9
                echo "        </div>
      </div>
  ...
  ";
      ...
      ";
                // line 19
                $this->loadTemplate("journal3/template/journal3/category_grid.twig", "journal3/template/journal3/module/categories.twig", 19)->display(twig_array_merge($context, ($context["context"] ?? null)));
                // line 20
                echo "    </div>
  ";
            }
